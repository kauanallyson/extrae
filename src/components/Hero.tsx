				...
				<div className="space-y-4">
					<div className="flex items-center justify-between border-b border-white/10 pb-4">
						<div>
							...
							<p className="text-xs text-slate-500">Do laudo à planilha pronta</p>
						</div>
					...
					<div className="grid gap-3">
						{[
							...
							{
								title: "3. Baixe a planilha",
								description: "A planilha é entregue pronta para uso.",
							},
						].map((item) => (
							<div
								key={item.title}
